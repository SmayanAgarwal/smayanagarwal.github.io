...
<iframe src="{{ '/files/DataMod_2025__Revised.pdf' | relative_url }}" width="100%" height="600px" style="border:none;">
  <p>Unable to display PDF. 
    <a href="{{ '/files/DataMod_2025__Revised.pdf' | relative_url }}" download>Download it here</a>.
  </p>
</iframe>
